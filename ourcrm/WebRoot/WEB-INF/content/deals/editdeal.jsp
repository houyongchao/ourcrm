    ...
    <div class="container">
		<div class="row">
			...
			<div class="span8">
				...
				<div class="wall">
					<form action="${basePath }/deal/savedeal.action?edit=edit" method="post">
						<fieldset>
							<div class="control-group">
								 <label class="control-label"><h3>和谁进行交易？</h3></label>
								 <label class="control-label">填写交易人的名字</label>
								<div class="controls">
									<input type="hidden" name="deals.id" value="${deal.id }">
									<input type="text" id="input01"  x-webkit-speech="undefined" name = "deals.dealWith" value="${deal.dealWith }"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label"><h3>交易的名字</h3></label>
								<div class="controls">
									<input type="text" id="input02"  x-webkit-speech="undefined" name = "deals.dealsname" value="${deal.dealsname }"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label"><h3>交易的描述</h3></label>
								<div class="controls">
									<textarea rows="5" id="input03" name = "deals.descs">${deal.descs}</textarea>
								</div>
							</div>
							<div class="control-group">
								...
								<div>
									<div class="input-prepend input-append">
										...
										<input type="text" id="input04" class="span2" name = "deals.money" value="${deal.money }"/>
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="deals.state">
										<c:choose>
											<c:when test="${fn:startsWith(deal.state,'gen') }">
												<option value="genzong" selected="selected">跟踪</option>
												<option value="chenggong">成功</option>
												<option value="diushi">丢失</option>
											</c:when>
											<c:when test="${fn:startsWith(deal.state,'cheng') }">
												<option value="genzong">跟踪</option>
												<option value="chenggong" selected="selected">成功</option>
												<option value="diushi">丢失</option>
											</c:when>
											<c:when test="${fn:startsWith(deal.state,'diu') }">
												<option value="genzong">跟踪</option>
												<option value="chenggong">成功</option>
												<option value="diushi" selected="selected">丢失</option>
											</c:when>
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="deals.dealtype.type" id="" >
										<c:choose>
											<c:when test="${fn:startsWith(deal.dealtype.type,'No') }">
											...
											<c:when test="${fn:startsWith(deal.dealtype.type,'Co') }">
												<option value="None">None</option>
												<option value="Copywriting" selected="selected">Copywriting</option>
												<option value="Print Project">Print Project</option>
												<option value="Strategy Consulting">Strategy Consulting</option>
												<option value="Web Site Design">Web Site Design</option>
											</c:when>
											<c:when test="${fn:startsWith(deal.dealtype.type,'Pr') }">
												<option value="None">None</option>
												<option value="Copywriting">Copywriting</option>
												<option value="Print Project" selected="selected">Print Project</option>
												<option value="Strategy Consulting">Strategy Consulting</option>
												<option value="Web Site Design">Web Site Design</option>
											</c:when>
											<c:when test="${fn:startsWith(deal.dealtype.type,'St') }">
												<option value="None">None</option>
												<option value="Copywriting">Copywriting</option>
												<option value="Print Project">Print Project</option>
												<option value="Strategy Consulting" selected="selected">Strategy Consulting</option>
												<option value="Web Site Design">Web Site Design</option>
											</c:when>
											<c:when test="${fn:startsWith(deal.dealtype.type,'We') }">
												<option value="None">None</option>
												<option value="Copywriting">Copywriting</option>
												<option value="Print Project">Print Project</option>
												<option value="Strategy Consulting">Strategy Consulting</option>
												<option value="Web Site Design" selected="selected">Web Site Design</option>
											</c:when>
										</c:choose>
									</select>
							...
							<div style = "margin-left:25px;font-size:14px">
								...
								<c:choose>
									<c:when test="${fn:startsWith(deal.view,'all') }">
										<div style = "margin-left:25px;font-size:14px">
											<input type="radio" name="deals.view" value="all" checked="checked"/>所有人<br/><br/>
											...
											<input type="radio" name="deals.view" value="user" id="onlyuser"/>选择指定的用户
									...
									<c:when test="${fn:contains(deal.view,deal.user.username) }">
										<div style = "margin-left:25px;font-size:14px">
											<input type="radio" name="deals.view" value="all"/>所有人<br/><br/>
											<input type="radio" name="deals.view" value="me" checked="checked"/>只有我能看见<br/>
											<input type="radio" name="deals.view" value="group" id="scan"/>选择指定的组
											<span id = "scangroup" style="margin-left:34px;">
												<select style="width:180px;" name="deals.view" id="group" multiple="multiple"></select>
											</span><br/>
									...
									<c:when test="${fn:startsWith(deal.view,'group') }">
										<div style = "margin-left:25px;font-size:14px">
											<input type="radio" name="deals.view" value="all"/>所有人<br/><br/>
											<input type="radio" name="deals.view" value="me"/>只有我能看见<br/>
											<input type="radio" name="deals.view" value="group" id="scan" checked="checked"/>选择指定的组
											<span id = "scangroup" style="margin-left:34px;">
												<select style="width:180px;" name="deals.view" id="group" multiple="multiple">
													<option value="${deal.view }" selected="selected">${deal.view }</option>
												</select>
											</span><br/>
											<input type="radio" name="deals.view" value="user" id="onlyuser"/>选择指定的用户
											<span id="chooseuser" style="margin-left:20px;">
									...
									<c:when test="${fn:startsWith(deal.view,'members') }">
										<div style = "margin-left:25px;font-size:14px">
											<input type="radio" name="deals.view" value="all"/>所有人<br/><br/>
											<input type="radio" name="deals.view" value="me"/>只有我能看见<br/>
											<input type="radio" name="deals.view" value="group" id="scan"/>选择指定的组
											...
											<input type="radio" name="deals.view" value="user" id="onlyuser" checked="checked"/>选择指定的用户
											<span id="chooseuser" style="margin-left:20px;">
												<select style="width:180px;" name="deals.view" id="alluser" multiple="multiple">
													<option value="${deal.view }" selected="selected">${deal.view }</option>
												</select>
											</span><br/>
										</div>

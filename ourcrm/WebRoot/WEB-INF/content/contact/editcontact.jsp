				...
				<form class="form-horizontal alert alert-success" action = "saveContact.action?method=edit" method = "post" style = "margin-top:-18px">
				    <fieldset>
					    <div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" class="input-xlarge" id="input01"  x-webkit-speech="undefined" name = "contact.contactname" value = "${contact.contactname}"/>
					    	</div>
					    </div>
						...
						<div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" class="input-xlarge" id="input01"  x-webkit-speech="undefined" name = "contact.position" value = "${contact.position }"/>
					    	</div>
					    </div>
					     ...
					     <div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" class="input-xlarge" id="input01"  x-webkit-speech="undefined" name = "contact.companyname" value = "${contact.companyname }"/>
					    	</div>
					    </div>
						    ...
						    <div class="controls">
						    	<c:forEach items = "${telList}" var = "t">
						    		...
						    		<select style = 'display:inline;width:85px' name = 'teltype'>
						    			...
						    			<c:choose>
						    				<c:when test="${t.type == '住宅'}">
						    					<option selected = "selected">住宅</option>
						    				</c:when>
						    				<c:otherwise>
							    				<option>住宅</option>
						    				</c:otherwise>
					    ...
					    <div class="control-group">
				            <label for="textarea" class="control-label">联系人简介</label>
				            <div class="controls">
						...
						<div style = "margin-left:80px;font-size:14px">
					     ...
					     <div class="form-actions alert alert-success" style = "border:none">
				            <button class="btn btn-primary" type="submit">保存此联系人</button>
				            <button class = "btn btn-info"><a href = "contact.action" style = "text-decoration:none;color:white">返回</a></button>
				         </div>
				    </fieldset>
				 </form> 
			</div>

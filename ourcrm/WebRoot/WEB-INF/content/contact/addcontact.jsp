		...
		<div class="row">
			...
			<div class="span9" >
				<div class="page-header alert alert-info">
					<h3>添加联系人或<a href = "addCompany.action">添加公司</a></h3><a href = "addMany.action">批量添加联系人</a>
				</div>
				<form class="form-horizontal alert alert-success" action = "saveContact.action" method = "post" style = "margin-top:-18px" id = "myform">
				    <fieldset>
					    <div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" class="input-xlarge" id="name"  x-webkit-speech="undefined" name = "contact.contactname"/><span id = "name-error"></span>
					    	</div>
					    </div>
						...
						<div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" class="input-xlarge" id="input01"  x-webkit-speech="undefined" name = "contact.position"/>
					    	</div>
					    </div>
					     ...
					     <div class="control-group">
						    ...
						    <div class="controls">
						    	<input type="text" class="input-xlarge" id="input01"  x-webkit-speech="undefined" name = "contact.companyname"/>
					    	</div>
					    </div>
						...
						<div style = "margin-left:80px;font-size:14px" class="control-group">
					     ...
					     <div class="form-actions alert alert-success" style = "border:none">
					     	<input type = "submit" value = "保存此联系人" name = "method" class  = "btn btn-primary"/>
					     	<input type = "submit" value = "保存并添加联系人" name = "method" class = "btn btn-primary"/>
